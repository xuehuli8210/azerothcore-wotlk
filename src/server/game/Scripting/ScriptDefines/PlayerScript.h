...
public:
    ...
    // After an item has been equipped
    virtual void OnUnEquip(Player* /*player*/, Item* /*it*/) { }
    ...
    //Before buying something from any vendor
    virtual bool OnBeforeStoreOrEquipNewItem(Player* /*player*/, uint32 /*vendorslot*/, uint32& /*item*/, uint8 /*count*/, uint8 /*bag*/, uint8 /*slot*/, ItemTemplate const* /*pProto*/, Creature* /*pVendor*/, VendorItem const* /*crItem*/, bool /*bStore*/)  { return true; }
