...
void WorldSession::SendTrainerList(ObjectGuid guid, uint32 npcTrainerId)
{
    std::string str = GetAcoreString(LANG_NPC_TAINER_HELLO);
    SendTrainerList(guid, str, npcTrainerId);
}

void WorldSession::SendTrainerList(ObjectGuid guid, const std::string& strTitle, uint32 npcTrainerId)
{
    ...
    TrainerSpellData const* trainer_spells =  sObjectMgr->GetNpcTrainerSpells(npcTrainerId);
